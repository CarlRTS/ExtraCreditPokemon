...
Clip c;
     ...
     */
    public Creditos() throws LineUnavailableException, IOException {
        initComponents();
        try {
            // Load your sound file (replace "your-sound-file.wav" with the actual file path)
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(
                    Menu.class.getResourceAsStream("/MusicaMenu/Creditos.wav"));
            // Get a Clip
    ...
    private void initComponents() {
        ...
        jLabel3.setText("IMAGENES: GOOGLE");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("BLACKJACK & GUESS WHAT IM THINKING");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("CARLOS MORENO (CARLRTS) & SERGIO BARRIOS");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesCreditos/Captura-removebg-preview.png"))); // NOI18N

        jLabel6.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("¡Agradecemos el feedback que nos puedan llegar a dar!");
